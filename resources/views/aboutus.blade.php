...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                <h1>Hi, I'm Maude.</h1>
                <p>This website is the practice of Laravel. Also the website for all the smurfy you. <br>
                    Join me and be smurfy!</p>
                <div class="col-sm-12 py-4 text-right">
                        <a class="btn btn-light" href="/" role="button">回到上一頁</a>
                </div>
            </div>
        </div>
    </body>
